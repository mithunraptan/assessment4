...
/**
 * Servlet implementation class DeletePolicyServlet
 */
...
//	        userService.addInsurancePolicy(policyName,premiumMonth,durationMonth);
	        userService.deleteInsurancePolicy(policyName);
	        
	        request.getRequestDispatcher("policy-delete-successfull-page.jsp")
